...
def index_all(limit: Optional[int] = None) -> Dict[str, int]:
    ...
    Example:
        >>> from src.ingestion.embeddings.index_helpers import index_all
...
def index_governance(limit: Optional[int] = None) -> int:
    ...
    Example:
        >>> from src.ingestion.embeddings.index_helpers import index_governance
...
def index_voting(limit: Optional[int] = None) -> int:
    ...
    Example:
        >>> from src.ingestion.embeddings.index_helpers import index_voting
...
def get_collection_stats() -> Dict[str, any]:
    ...
    Example:
        >>> from src.ingestion.embeddings.index_helpers import get_collection_stats
...
def verify_indexing(test_limit: int = 5) -> bool:
    ...
    Example:
        >>> from src.ingestion.embeddings.index_helpers import verify_indexing
        >>> if verify_indexing():
