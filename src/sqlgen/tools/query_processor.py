...
class ToolBasedQueryProcessor:
    def __init__(self, embedding_manager=None, openai_client=None, gemini_client=None):
        ...
        reset_registry()
        self.registry = get_tool_registry(self.db_config, self.table_name, self.timeout)
...
def create_tool_processor(embedding_manager=None) -> ToolBasedQueryProcessor:
